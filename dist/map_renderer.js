		...
		function render() {
			...
			var option = {
				...
				series: [{
					...
					data: [{ name: '北京', value: ctrl.mapValue.北京 }, { name: '天津', value: ctrl.mapValue.天津 }, { name: '上海', value: ctrl.mapValue.上海 }, { name: '重庆', value: ctrl.mapValue.重庆 }, { name: '河北', value: ctrl.mapValue.河北 }, { name: '山西', value: ctrl.mapValue.山西 }, { name: '辽宁', value: ctrl.mapValue.辽宁 }, { name: '吉林', value: ctrl.mapValue.吉林 }, { name: '黑龙江', value: ctrl.mapValue.黑龙江 }, { name: '江苏', value: ctrl.mapValue.江苏 }, { name: '浙江', value: ctrl.mapValue.浙江 }, { name: '安徽', value: ctrl.mapValue.安徽 }, { name: '福建', value: ctrl.mapValue.福建 }, { name: '江西', value: ctrl.mapValue.江西 }, { name: '山东', value: ctrl.mapValue.山东 }, { name: '河南', value: ctrl.mapValue.河南 }, { name: '湖北', value: ctrl.mapValue.湖北 }, { name: '湖南', value: ctrl.mapValue.湖南 }, { name: '广东', value: ctrl.mapValue.广东 }, { name: '海南', value: ctrl.mapValue.海南 }, { name: '四川', value: ctrl.mapValue.四川 }, { name: '贵州', value: ctrl.mapValue.贵州 }, { name: '云南', value: ctrl.mapValue.云南 }, { name: '陕西', value: ctrl.mapValue.陕西 }, { name: '甘肃', value: ctrl.mapValue.甘肃 }, { name: '青海', value: ctrl.mapValue.青海 }, { name: '台湾', value: ctrl.mapValue.台湾 }, { name: '内蒙古', value: ctrl.mapValue.内蒙古 }, { name: '广西', value: ctrl.mapValue.广西 }, { name: '西藏', value: ctrl.mapValue.西藏 }, { name: '宁夏', value: ctrl.mapValue.宁夏 }, { name: '新疆', value: ctrl.mapValue.新疆 }, { name: '香港', value: ctrl.mapValue.香港 }, { name: '澳门', value: ctrl.mapValue.澳门 }]
				}]
			};
			// 使用刚指定的配置项和数据显示图表。
