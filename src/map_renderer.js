			...
			series: [
				{
					...
					data:[
						...
						{name:'河北', value: _.round(ctrl.mapValue.河北)},
						{name:'山西', value: _.round(ctrl.mapValue.山西)},
						{name:'辽宁', value: _.round(ctrl.mapValue.辽宁)},
						{name:'吉林', value: _.round(ctrl.mapValue.吉林)},
						{name:'黑龙江', value: _.round(ctrl.mapValue.黑龙江)},
						{name:'江苏', value: _.round(ctrl.mapValue.江苏)},
						{name:'浙江', value: _.round(ctrl.mapValue.浙江)},
						{name:'安徽', value: _.round(ctrl.mapValue.安徽)},
						{name:'福建', value: _.round(ctrl.mapValue.福建)},
						{name:'江西', value: _.round(ctrl.mapValue.江西)},
						{name:'山东', value: _.round(ctrl.mapValue.山东)},
						{name:'河南', value: _.round(ctrl.mapValue.河南)},
						{name:'湖北', value: _.round(ctrl.mapValue.湖北)},
						{name:'湖南', value: _.round(ctrl.mapValue.湖南)},
						{name:'广东', value: _.round(ctrl.mapValue.广东)},
						{name:'海南', value: _.round(ctrl.mapValue.海南)},
						{name:'四川', value: _.round(ctrl.mapValue.四川)},
						{name:'贵州', value: _.round(ctrl.mapValue.贵州)},
						{name:'云南', value: _.round(ctrl.mapValue.云南)},
						{name:'陕西', value: _.round(ctrl.mapValue.陕西)},
						{name:'甘肃', value: _.round(ctrl.mapValue.甘肃)},
						{name:'青海', value: _.round(ctrl.mapValue.青海)},
						{name:'台湾', value: _.round(ctrl.mapValue.台湾)},
						{name:'内蒙古', value: _.round(ctrl.mapValue.内蒙古)},
						{name:'广西', value: _.round(ctrl.mapValue.广西)},
						{name:'西藏', value: _.round(ctrl.mapValue.西藏)},
						{name:'宁夏', value: _.round(ctrl.mapValue.宁夏)},
						{name:'新疆', value: _.round(ctrl.mapValue.新疆)},
						{name:'香港', value: _.round(ctrl.mapValue.香港)},
						{name:'澳门', value: _.round(ctrl.mapValue.澳门)},
					]
				}
			]
		};
